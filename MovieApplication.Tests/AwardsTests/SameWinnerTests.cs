...
{
    internal class ISameWinnerAwardDbContext : IAwardDbContext
    {
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            optionsBuilder.UseInMemoryDatabase("test_samewinnerawards");
        }
    ...
    internal class SameWinnerTests : IntegrationTest<ISameWinnerAwardDbContext>
    {
        [Test]
        ...
        public async Task GetMinMaxVictories_WithoutWinners_ReturnsCorrectProducer()
        {
            ...
            responseDto.Min.Count.Should().Be(1);
