...
{
    internal class INoWinnersAwardDbContext : IAwardDbContext
    {
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            optionsBuilder.UseInMemoryDatabase("test_nowinnersawards");
        }
    ...
    internal class NoWinnersTests : IntegrationTest<INoWinnersAwardDbContext>
    {
        [Test]
